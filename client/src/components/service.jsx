...
export default function Service() {
  return (
    <section className="service-wrapper">
      ...
      <ul>
        <li>
          <img src="client\public\assets\c-sharp.png" alt="csharp icon"></img>
        ...
        <li>
        <img src="client\public\assets\java-script.png" alt="javascript icon"></img>
        ...
        <li>
        <img src="client\public\assets\database-management.png" alt="database icon"></img>
        ...
        <li>
        <img src="client\public\assets\brain.png" alt="brain icon"></img>
        ...
        <li>
        <img src="client\public\assets\linux.png" alt="linux icon"></img>
        ...
        <li>
        <img src="client\public\assets\social.png" alt="git icon"></img>
