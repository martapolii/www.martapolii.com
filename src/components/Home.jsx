...
export default function Home() {
  return (
    <div className="home-wrapper">
      ...
      <img className="CheekyCode" src="./public/assets/coderFunction.png" alt="C# code snipet of an object of the Coder class defining variables that align with my hard/soft skills"/>
    </div>
  );
}
