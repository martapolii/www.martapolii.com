...
export default function Service() {
  return (
    <section className="service-wrapper">
      ...
      <ul>
        <li>
          <img src="./public/assets/c-sharp.png" alt="csharp icon"></img>
        ...
        <li>
        <img src="./public/assets/java-script.png" alt="javascript icon"></img>
        ...
        <li>
        <img src="./public/assets/database-management.png" alt="database icon"></img>
        ...
        <li>
        <img src="./public/assets/brain.png" alt="brain icon"></img>
        ...
        <li>
        <img src="./public/assets/social.png" alt="git icon"></img>
