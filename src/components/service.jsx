...
export default function Service() {
  return (
    <section className="service-wrapper">
      ...
      <ul>
        <li>
          <img src="/c-sharp.png" alt="csharp icon"></img>
        ...
        <li>
        <img src="/java-script.png" alt="javascript icon"></img>
        ...
        <li>
        <img src="/database-management.png" alt="database icon"></img>
        ...
        <li>
        <img src="/brain.png" alt="brain icon"></img>
        ...
        <li>
        <img src="/linux.png" alt="linux icon"></img>
        ...
        <li>
        <img src="/social.png" alt="git icon"></img>
